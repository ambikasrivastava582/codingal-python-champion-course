...
icon = pygame.image.load('png3.png')
pygame.display.set_icon(icon)

# Player
playerImg = pygame.image.load('png2.jpg')
...
for _i in range(num_of_enemies):
    enemy_image = pygame.image.load('png3.jpg')
...
# Bullet
bulletImg = pygame.image.load('png1.jpg')
